 ...
 * entity enters another's radius. It is then the responsibility of other individual sensing sub-systems, such as {@link
 * VolumeSensingSystem} and {@link ConeSensingSystem} to determine if the triggering entity has been detected.
 */
@RegisterSystem
